...
| Relative Bash hook path | For custom Bash hooks, avoid repo-relative commands such as `python3 scripts/guard.py` unless a canary proves they survive cwd changes; prefer absolute or verified project-rooted paths. |
