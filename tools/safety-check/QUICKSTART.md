...
environment, inspect the backup list and restore the named pre-trial snapshot
if you want the exact previous settings file, then verify cleanup before you
leave it:
