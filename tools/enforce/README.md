...
PreToolUse hooks solve all five. They run as code before every tool call, they fire in every context (including subagents), and they return a hard block that the model cannot override.
