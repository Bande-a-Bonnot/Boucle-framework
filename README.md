...
Claude Code hooks that actually enforce your rules. 9 hooks, ~1700 tests, [190 documented platform limitations](tools/enforce/#known-limitations) with workarounds.
