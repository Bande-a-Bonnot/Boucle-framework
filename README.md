...
Claude Code hooks that actually enforce your rules. 7 installable hooks, plus enforcement and audit tooling, 1,900+ tests, [933 known Claude Code gaps documented](tools/enforce/README.md#known-limitations) with severity ratings and workarounds.
