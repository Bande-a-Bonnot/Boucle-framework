...
Claude Code hooks that actually enforce your rules. 9 hooks, ~1758 tests, [905 known Claude Code gaps documented](tools/enforce/#known-limitations) with severity ratings and workarounds.
