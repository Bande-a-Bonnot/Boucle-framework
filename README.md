...
Claude Code hooks that actually enforce your rules. 9 hooks, ~1900 tests, [206 known Claude Code gaps documented](tools/enforce/#known-limitations) with workarounds.
