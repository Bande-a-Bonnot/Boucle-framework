...
Claude Code hooks that actually enforce your rules. 9 hooks, ~1950 tests, [368 known Claude Code gaps documented](tools/enforce/#known-limitations) with severity ratings and workarounds.
